...
import { Body2, Button, Flex } from '@dds/shared';
  ...
  return (
    <Flex alignItems="start" justifyContent="start" gap={4}>
      ...
      <Button
        ...
        className="text-md fixed bottom-6 left-6 right-6 z-20 h-14 font-semibold lg:static lg:left-auto lg:right-auto lg:w-[25%] lg:self-start"
      >

...
import { Body2, Flex, Skeleton } from '@dds/shared';
  ...
  return (
    <>
      ...
      <Flex alignItems="start" gap={4}>
        ...
        <Skeleton className="fixed bottom-6 left-6 right-6 h-14 rounded-lg lg:static lg:left-auto lg:right-auto lg:w-[25%] lg:self-center" />
      </Flex>
    </>
  );
}

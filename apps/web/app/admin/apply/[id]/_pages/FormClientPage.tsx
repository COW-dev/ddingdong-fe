...
import { TabItem, Tabs } from '@dds/shared';
...
export function FormClientPage({ id }: { id: number }) {
  ...
  return (
    <>
      ...
      <Link
        href={`/apply/${id}/edit`}
        className="fixed bottom-10 right-5 flex h-12 items-center justify-center rounded-[100px] bg-blue-500 px-8 py-3 font-semibold text-white hover:bg-blue-600 md:bottom-20 md:right-20 md:px-10 md:py-4"
      >
        지원서 양식 관리
      </Link>
    </>

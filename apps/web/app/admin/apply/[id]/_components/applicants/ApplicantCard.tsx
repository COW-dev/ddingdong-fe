...
import { Badge, Body1, Body3, Checkbox, Flex } from '@dds/shared';

import { Applicant } from '@/_api/types/apply';
import { STATUS_TYPE } from '@/admin/apply/[id]/_constants/apply';
import {
  getDocumentStatus,
  getInterviewStatus,
} from '@/admin/apply/[id]/_utils/filter';

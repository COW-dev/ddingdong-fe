'use client';
import { Flex, Title1, Title3 } from '@dds/shared';
import { useSuspenseQuery } from '@tanstack/react-query';

import { applyQueryOptions } from '@/_api/queries/apply';
import { QuestionList } from '@/admin/apply/[id]/statistics/_components/QuestionList';
import { Summary } from '@/admin/apply/[id]/statistics/_components/Summary';

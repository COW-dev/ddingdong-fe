...
import { BarChart } from '@/admin/apply/[id]/statistics/_components/_chart/BarChart';
import { LineChart } from '@/admin/apply/[id]/statistics/_components/_chart/LineChart';

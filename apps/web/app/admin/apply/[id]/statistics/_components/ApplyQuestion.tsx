import { Accordion, AccordionItem, Body3, Caption1, Card } from '@dds/shared';

import { ApplyQuestion } from '@/_api/types/apply';
import { QuestionMultipleContent } from '@/admin/apply/[id]/statistics/_components/QuestionMultipleContent';
import { QuestionSingleContent } from '@/admin/apply/[id]/statistics/_components/QuestionSingleContent';

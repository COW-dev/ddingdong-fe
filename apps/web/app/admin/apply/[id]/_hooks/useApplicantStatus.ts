...
import { useUpdateApplicantStatus } from '@/_api/mutations/apply';
import { ApplicantStatus } from '@/_api/types/apply';
import { getNextStatus } from '@/admin/apply/[id]/_utils/filter';

...
import { Body3, Caption1, Flex, Icon } from '@dds/shared';
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {isOpen && sendingList.length > 0 && (
        <div className="absolute right-0 top-full z-10 mt-2 w-72 rounded-xl border border-gray-100 bg-white p-2 shadow-lg">
          <div className="p-2">
            <Body3
              weight="bold"
              color="gray"

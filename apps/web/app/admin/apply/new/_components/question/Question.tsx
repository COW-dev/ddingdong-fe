...
import { Body3, Flex, IconButton, Input, Switch } from '@dds/shared';

import { FormField, QuestionType, SectionFormField } from '@/_api/types/apply';
import { useFormFieldContext } from '@/admin/apply/new/_contexts/FormFieldContext';
...
function QuestionComponent({
  ...
  return (
    ...
    >
      {canDrag && !readOnly && (
        <div
          className="absolute left-1/2 top-0 z-10 -translate-x-1/2 -translate-y-1/2 cursor-grab p-2 active:cursor-grabbing"
          draggable={false}
        >
          <IconButton
            iconName="drag"

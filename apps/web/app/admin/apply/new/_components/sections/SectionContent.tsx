...
import { Button } from '@dds/shared';

import { QuestionList } from '@/admin/apply/new/_components/question/QuestionList';
import { AddSectionModal } from '@/admin/apply/new/_components/sections/AddSectionModal';
import { DeleteSectionModal } from '@/admin/apply/new/_components/sections/DeleteSectionModal';
import { EditSectionModal } from '@/admin/apply/new/_components/sections/EditSectionModal';
import { SectionTabs } from '@/admin/apply/new/_components/sections/SectionTabs';

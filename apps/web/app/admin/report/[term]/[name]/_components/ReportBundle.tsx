'use client';
import { Accordion, AccordionItem, Body3, Caption1, Flex } from '@dds/shared';

import { ReportAPIResponse } from '@/_api/types/report';
import { Report } from '@/admin/report/[term]/[name]/_components/Report';

...
import { Body2, Body3, Button, Flex, Title2, usePortal } from '@dds/shared';
import { useSuspenseQuery } from '@tanstack/react-query';
import { toast } from 'react-hot-toast';

import { ApiError } from '@/_api/fetcher';
import { useDeleteNotice } from '@/_api/mutations/notice';
import { noticeQueryOptions } from '@/_api/queries/notice';
import { ROLE_TYPE, RoleType } from '@/_constants/role';
import { NoticeDetailContent } from '@/notice/[id]/_components/NoticeDetailContent';
import { NoticeDetailFile } from '@/notice/[id]/_components/NoticeDetailFile';

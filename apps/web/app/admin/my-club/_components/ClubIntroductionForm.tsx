...
import { Body3, Caption1, Flex, MediaUpload } from '@dds/shared';
import TextareaAutosize from 'react-textarea-autosize';

import { ClubDetail } from '@/_api/types/club';
          ...
          <>
            {introductionImage ? (
              ...
              <Flex
                ...
                className="h-30 w-full rounded-xl border border-gray-100 bg-gray-50 p-4 text-gray-300 outline-none md:mb-6 md:mt-3 md:p-5"
              >

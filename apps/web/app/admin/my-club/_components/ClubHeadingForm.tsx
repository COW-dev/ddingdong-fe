...
import { Body2, Flex, Input, Title1 } from '@dds/shared';

import { ClubDetail } from '@/_api/types/club';
import { deptCaptionColor } from '@/_constants/color';
import { ClubHeading } from '@/club/[id]/_components/header/ClubHeading';

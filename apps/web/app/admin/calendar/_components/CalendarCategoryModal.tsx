...
export function CalendarCategoryModal({
  ...
  return (
    <Modal isOpen={isOpen} closeModal={close} closeOnOutsideClick={!isPending}>
      <Flex
        dir="col"
      ...
      >
        ...
        <Flex as="ul" dir="col" className="list-none divide-y divide-gray-200">
          {categories.length === 0 && (
            ...
            >
              ...
              {deleteCategoryId === category.id ? (
                <Flex alignItems="center" className="gap-2">
                  <Body3 className="text-red-300">삭제할까요?</Body3>
                  <Button
                    variant="tertiary"
                    size="sm"

import { Body3, Card, Flex, ImageGallery } from '@dds/shared';

import { UrlType } from '@/_api/types/file';
import { DetailFix } from '@/_api/types/fix';
import { FixPostInfo } from '@/admin/fix/[id]/_components/FixPostInfo';

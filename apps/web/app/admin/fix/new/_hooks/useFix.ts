...
import { useCreateFix } from '@/_api/mutations/fix';
import { FixAPIRequest } from '@/_api/types/fix';
import { usePresignedUrl } from '@/_hooks/usePresignedUrl';
import { UploadRecord } from '@/admin/notice/new/_hook/useNewNotice';

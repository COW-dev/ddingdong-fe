...
export default function ClubCard({ id, name, tag, category }: ClubProps) {
  ...
  return (
    <li
      key={id}
      className="rounded-xl border-[1.5px] border-gray-100 bg-white transition-colors active:border-gray-200 active:bg-gray-50 md:hover:border-gray-200 md:hover:bg-gray-50"
    >
      <Link
        href={`/club/${id}`}

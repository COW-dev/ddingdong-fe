...
export default function Index() {
  ...
  return (
    <>
      ...
      <div className="mt-10 flex h-104 w-full flex-col rounded-xl border border-gray-100 md:mt-14 md:flex-row">
        {/* 정보 */}
        ...
        {/* 내용 */}
        <div className="flex h-full w-full flex-col md:w-1/2 md:flex-row">

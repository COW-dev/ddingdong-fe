...
export default function AdminPage({ role }: { role: string }) {
  ...
  function handleInfoElement() {
    if (role === ROLE_TYPE.ROLE_ADMIN) {
      setInfoElement(
        <div className="mt-7 text-2xl leading-tight font-bold md:mt-10 md:flex md:text-3xl">
  ...
  return (
    <>
      ...
      <div className="relative mt-7">{/* <Slider /> */}</div>
      <div className="mt-2 grid w-full grid-cols-1 gap-3 sm:grid-cols-3 md:mt-6 md:gap-5">
        ...
        >
          ...
          <div className="mt-2 text-sm leading-tight font-semibold text-gray-400 md:mt-3 md:text-base md:leading-tight">
            ...
            .map((notice) => (
              <li key={notice.id} className="mb-1 w-full border-b">
                ...
                >
                  ...
                  <div className="mt-0.5 mb-2 text-sm font-medium text-gray-400 md:text-base">
